...
1. **Window Levels & Multi-Space Pinning**: See [`references/macos-notch-and-transparency.md`](./references/macos-notch-and-transparency.md).
...
2. **Mouse Event Forwarding**:
   ...
   - On mouse enter over interactive components, call `window.codenotch.setIgnoreMouseEvents(false)`.
   - On mouse leave, call `window.codenotch.setIgnoreMouseEvents(true, { forward: true })`.
...
2. **Custom Curves & Flares**: See [`references/notch-geometry-and-flares.md`](./references/notch-geometry-and-flares.md).
...
- [macOS Notch Geometry & Transparency](./references/notch-geometry-and-flares.md)
